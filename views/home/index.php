...
<section class="">
    ...
    <div class="row mx-md-4 m-auto mt-1 mb-0">
        <div class="col-md-4 d-none mx-auto d-md-block bg-body-tertiary rounded shadow" id="contOfertas" style=" max-height: 86vh;overflow: auto;">
            <h3 class="card card-outline card-primary p-1 mx-1">Ofertas</h3>
            <!-- OFERTAS 1 -->
            <div id="contTargetasOfertas">
        ...
        <div class=" col-md-8 col-12 shadow-lg  p-3 pt-0 pb-0 mb-0 bg-body-tertiary rounded " id="contMercado" style=" max-height: 86vh;overflow: auto;">
            <h3 class="card card-outline card-primary p-1 mx-1" style="margin-top: -15px;">Mercado</h3>
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-3" id="contTargetasMercado">
        ...
        <div class=" col-12 shadow-lg  p-3 pt-0 pb-0 mb-0 bg-body-tertiary rounded d-none" id="contADD" style=" max-height: 86vh;overflow: auto;">
            <h3 class="card card-outline card-primary p-1 mx-1" style="margin-top: -10px;">Añadir Venta</h3>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#ofertas").click(function(e) {
                ...
                // Remover la clase d-none del elemento #contOfertas
                $("#contOfertas").removeClass("d-none");
                $("#contOfertas").removeClass("col-md-a");

                // Agregar la clase d-none al elemento #productos
